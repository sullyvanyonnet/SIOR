 ...
 */
@WebServlet("/getCountPanierClient")
public class getCountPanierClient extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public getCountPanierClient() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.write(objectMapper.writeValueAsBytes(
					con.sendGet("http://localhost:9000/api/getCountPanierClient?cli_id=" + cli_id)));
			out.close();
