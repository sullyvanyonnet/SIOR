...
class AfficheVoyage extends React.Component {
    ...
    afficheUneDestination(id) {
        ...
        this.state.JSONVoyages.map((k) =>
            id == k.voy_id ?
                this.state.tableVoyages = <UnVoyageComplet updateHeader={this.props.updateHeader} handler={this.getAllVoyages} EtatConnexion={this.state.EtatConnexion} voyageId={k.voy_id} titre={k.voy_nom} dateDebut={k.voy_debut} dateFin={k.voy_fin} Text={k.voy_description} IdPhoto={k.pho_id} CheminPhoto={k.pho_chemin} description={k.voy_description}prix={k.voy_prix}/>
                :
                null
